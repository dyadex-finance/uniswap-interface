...
import { Currency, Token, V3_CORE_FACTORY_ADDRESSES } from '@dyadex-finance/sdk-core'
import { FeeAmount, TICK_SPACINGS, tickToPrice as tickToPriceV3, Pool as V3Pool } from '@dyadex-finance/v3-sdk'
import { tickToPrice as tickToPriceV4, Pool as V4Pool } from '@dyadex-finance/v4-sdk'
...
export function usePoolActiveLiquidity({
  ...
  const defaultChainId = multichainContext.chainId ?? UniverseChainId.Monad
