...
import { CurrencyAmount, Percent, Token, TradeType, WETH9 } from '@dyadex-finance/sdk-core'
...
export const ETH_MAINNET = nativeOnChain(UniverseChainId.Monad)
...
export const WETH_INFO: CurrencyInfo = {
  currency: WETH9[UniverseChainId.Monad],
  logoUrl:
    'https://raw.githubusercontent.com/Uniswap/assets/master/blockchains/ethereum/assets/0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2/logo.png',
  currencyId: WETH9[UniverseChainId.Monad].address,
  safetyInfo: benignSafetyInfo,
}
